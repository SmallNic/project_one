...
movies.flashcards.create ([
  ...
  {front:"In what movie did George Carlin help a musical duo save the future?", back:"Bill and Ted's Excellent Adventure", status:"Unanswered", user_answer:nil}
  ])
...
history.flashcards.create ([
  {front:"What part of a knight's body did the greaves cover?", back:"Shins", status:"Unanswered", user_answer:nil},
